...
const { createPost, getFeed, getPostDetail, updateScore, toggleLike, getLikeStatus, getComments, addComment, deleteComment, getPostsByProduct } = require('../controllers/postController');
