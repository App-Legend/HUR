...
\restrict mfXDHzVyjvwe86RcB08gF3quWBeLxSfOycMEFEKhhzKGdVoDZypKrGnTzgAmzVf
...
--
-- Name: innisfree_products; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.innisfree_products (
    id integer NOT NULL,
    name text,
    price text,
    image text
...
--
-- Name: innisfree_products_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.innisfree_products_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: innisfree_products_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.innisfree_products_id_seq OWNED BY public.innisfree_products.id;
...
CREATE TABLE public."user" (
    ...
    bio text,
    profile_image text,
    aesthetic_tag character varying(20),
...
--
-- Name: innisfree_products id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.innisfree_products ALTER COLUMN id SET DEFAULT nextval('public.innisfree_products_id_seq'::regclass);
...
2	1	2026-05-23 17:02:55.982552
3	2	2026-05-23 17:40:00.135776
5	1	2026-05-27 12:30:34.465421
6	1	2026-05-31 15:11:29.173201
6	3	2026-05-31 15:11:31.022426
\.


--
-- Data for Name: innisfree_products; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.innisfree_products (id, name, price, image) FROM stdin;
\.
...
COPY public.products (id, brand, name, image, source) FROM stdin;
...
COPY public."user" (id, name, nickname, username, gender, birth_date, email, password, bio, profile_image, aesthetic_tag, background_image) FROM stdin;
2	민지	ming2	minji99	여성	1999-03-12	minji@gmail.com	$2b$10$UXEOACk34RFaA15pw/rxQef6QfYTz7ApkTGyzOyyoDqqzbMT3ZBAe		http://10.0.2.2:3000/uploads/1779524334554_diefojmokwl.jpg	차분	http://10.0.2.2:3000/uploads/1779524488193_c9ri4qw4ucl.jpg
1	su	susu3	saeodixx224	여성	1999-01-01	dan@naver.com	$2b$10$V4znYKKg9sbBwguSJbimGO86rz3Vg8ta8YoaMLgM5gWj2NS82yLBu	dd	http://10.0.2.2:3000/uploads/1779525353551_mdmh0u0248c.jpg	섹시	http://10.0.2.2:3000/uploads/1779525151691_aea39djhxla.jpg
3	suyeon	suyeon2	susu2	여성	1999-01-14	hi@naver.com	$2b$10$TiUoOs.jqS2H9YbOmiykaexC..BwbpjAS7PGPrN.6fhLmgZVJRrym	hi	http://10.0.2.2:3000/uploads/1779525580239_25whubzwfyk.jpg	청순	\N
4	gun	gunoo2	gunoo13	기타	1999-01-01	gun@gmail.com	$2b$10$MPS/Auk8rSZ9GxeJig4d0.aLynhfLBRh97yOqUnT8Cps03G9FhWDa	d	http://10.0.2.2:3000/uploads/1779792483467_5kc8vudsbv4.jpg	시크	http://10.0.2.2:3000/uploads/1779792477392_3i25o0iugej.jpg
5	tt	tt	tt_tt	여성	1999-01-01	tt@tt.com	$2b$10$FZAqU34OHT1dKfH2HaEzG.Efml1SM/ixQEjJPeZWaxRJg8hGNUwOi	\N	\N	\N	\N
6	d	fd	aa	남성	1999-01-01	aa@naver.com	$2b$10$sN7XjdK1kr1Z4BDwGdCJTOxrAjf0JfroOHURCs.Lhop9adqkB.Pge	\N	\N	\N	\N
\.


--
-- Name: innisfree_products_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.innisfree_products_id_seq', 1, false);
...
--
-- Name: innisfree_products innisfree_products_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.innisfree_products
    ADD CONSTRAINT innisfree_products_name_key UNIQUE (name);


--
-- Name: innisfree_products innisfree_products_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.innisfree_products
    ADD CONSTRAINT innisfree_products_pkey PRIMARY KEY (id);
...
--
-- Name: user user_nickname_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.follow
    ADD CONSTRAINT follow_follower_id_fkey FOREIGN KEY (follower_id) REFERENCES public."user"(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.follow
    ADD CONSTRAINT follow_following_id_fkey FOREIGN KEY (following_id) REFERENCES public."user"(id) ON DELETE CASCADE;
...
\unrestrict mfXDHzVyjvwe86RcB08gF3quWBeLxSfOycMEFEKhhzKGdVoDZypKrGnTzgAmzVf
